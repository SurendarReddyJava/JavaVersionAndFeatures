...
// LocalDate example
        ...
        LocalDate specificDate = LocalDate.of(2024, Month.SEPTEMBER, 1);
...
// Instant example
        ...
        Instant specificInstant = Instant.ofEpochSecond(System.currentTimeMillis());
...
// Period example
        ...
        System.out.println("Period getDays diff " + betweenDates.getDays());
        System.out.println("Period getMonths diff " + betweenDates.getMonths());
