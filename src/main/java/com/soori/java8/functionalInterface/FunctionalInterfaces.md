Java 8 introduced several functional interfaces to support lambda expressions and functional programming. Here are some of the key functional interfaces added:
